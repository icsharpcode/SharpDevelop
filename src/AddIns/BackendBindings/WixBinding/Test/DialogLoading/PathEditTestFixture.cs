...
{
	/// <summary>
	/// Tests the loading of a simple Wix dialog that contains a path edit text box.
	/// </summary>
	[TestFixture]
	public class PathEditTestFixture : DialogLoadingTestFixtureBase
	{
		string name;
		string text;
		Point location;
		...
		string GetWixXml()
		{
			return "<Wix xmlns='http://schemas.microsoft.com/wix/2006/wi'>\r\n" +
				...
				"\t\t\t\t<Control Id='ControlId' Type='PathEdit' X='10' Y='10' Width='50' Height='15' Text='Text'/>\r\n" +
				"\t\t\t</Dialog>\r\n" +
				"\t\t</UI>\r\n" +
				"\t</Fragment>\r\n" +
				"</Wix>";
