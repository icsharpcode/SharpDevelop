...
namespace ICSharpCode.WpfDesign
{
	...
	public class ServiceContainer : IServiceProvider
	{
		...
		public void AddService(Type serviceInterface, object serviceInstance)
		{
			...
			//TODO: replace required by ITopLevelWindowService
			_services[serviceInterface] = serviceInstance;
		...
		public T GetServiceOrThrowException<T>() where T : class
		{
		...
		/// </summary>
		public void SubscribeToService<T>(Action<T> serviceAvailableAction) where T : class
		{
