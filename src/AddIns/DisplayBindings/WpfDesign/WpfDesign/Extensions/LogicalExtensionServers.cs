...
namespace ICSharpCode.WpfDesign.Extensions
{
		...
		where B : ExtensionServer
	{
		...
		{
			base.OnInitialized();
			_a = Context.ExtensionManager.GetExtensionServer(new ExtensionServerAttribute(typeof(A)));
			_b = Context.ExtensionManager.GetExtensionServer(new ExtensionServerAttribute(typeof(B)));
