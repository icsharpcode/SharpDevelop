	...
	public sealed class ResizeThumbExtension : PrimarySelectionAdornerProvider
	{
		...
		void drag_Started(DragListener drag)
		{
			...
			if (resizeBehavior != null) 
				...
				changeGroup = this.Context.UndoService.OpenGroup("Resize", extendedItemArray);
			}
		}
		...
		{
			bool isPrimarySelection = this.Context.SelectionService.PrimarySelection == this.ExtendedItem;
