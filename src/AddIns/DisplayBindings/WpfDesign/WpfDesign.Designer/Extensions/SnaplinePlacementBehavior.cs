	...
	public class SnaplinePlacementBehavior : DefaultPlacementBehavior
	{
		...
		void CreateSurface(PlacementOperation operation)
		{
			//if (ExtendedItem.Services.GetService<IDesignPanel>() != null) 
			{
				...
				ExtendedItem.Context.DesignPanel.Adorners.Add(adornerPanel);
		...
		void BuildMaps(PlacementOperation operation)
		{
			...
			foreach (var item in ExtendedItem.Content.CollectionElements
		...
		{
			if (surface != null) {
				ExtendedItem.Context.DesignPanel.Adorners.Remove(adornerPanel);
				adornerPanel = null;
				surface = null;
				horizontalMap = null;
				verticalMap = null;
