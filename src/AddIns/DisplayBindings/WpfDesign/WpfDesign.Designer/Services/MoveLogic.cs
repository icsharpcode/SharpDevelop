...
namespace ICSharpCode.WpfDesign.Designer.Services
{
    class MoveLogic
    {
        public MoveLogic(DesignItem clickedOn)
        {
			...
			selectedItems = clickedOn.Context.SelectionService.SelectedItems;
        ...
        public IDesignPanel DesignPanel {
			get { return clickedOn.Context.DesignPanel; }
        }
		...
		public void HandleDoubleClick()
		{
			if (selectedItems.Count() == 1) {
				IEventHandlerService ehs = clickedOn.Context.GetService<IEventHandlerService>();
				if (ehs != null) {
