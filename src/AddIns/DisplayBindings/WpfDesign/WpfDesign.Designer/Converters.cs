...
namespace ICSharpCode.WpfDesign.Designer.Converters
{
	...
	//public class OutlineNodeFromDesignItemConverter : IValueConverter
	//{
	//    public static OutlineNodeFromDesignItemConverter Instance = new OutlineNodeFromDesignItemConverter();

	//    public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
	//    {
	//        var designItem = value as XamlDesignItem;
	//        if (designItem != null) {
	//            return designItem.Annotation<OutlineNode>();
	//        }
	//        return null;
	//    }
