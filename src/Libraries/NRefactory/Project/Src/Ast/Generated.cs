	...
	public class MethodDeclaration : ParametrizedNode {
		...
		public override string ToString() {
			return string.Format("[MethodDeclaration TypeReference={0} Body={1} HandlesClause={2} InterfaceImplemen" +
					"tations={3} Templates={4} IsExtensionMethod={5} Name={6} Parameters={7} Attribut" +
					"es={8} Modifier={9}]", TypeReference, Body, GetCollectionString(HandlesClause), GetCollectionString(InterfaceImplementations), GetCollectionString(Templates), IsExtensionMethod, Name, GetCollectionString(Parameters), GetCollectionString(Attributes), Modifier);
		}
	}
	...
	public class OperatorDeclaration : MethodDeclaration {
		...
		public override string ToString() {
			return string.Format("[OperatorDeclaration ConversionType={0} ReturnTypeAttributes={1} OverloadableOper" +
					...
					"6} Templates={7} IsExtensionMethod={8} Name={9} Parameters={10} Attributes={11} " +
					"Modifier={12}]", ConversionType, GetCollectionString(ReturnTypeAttributes), OverloadableOperator, TypeReference, Body, GetCollectionString(HandlesClause), GetCollectionString(InterfaceImplementations), GetCollectionString(Templates), IsExtensionMethod, Name, GetCollectionString(Parameters), GetCollectionString(Attributes), Modifier);
		}
	}
