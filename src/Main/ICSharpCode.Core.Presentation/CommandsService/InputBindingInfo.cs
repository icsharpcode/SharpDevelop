	...
	public class InputBindingInfo : BindingInfoBase
	{
		...
		public ObservableInputGestureCollection DefaultGestures { 
			...
			set {
				...
				if(IsRegistered && (UserGestureProfileManager.CurrentProfile == null || UserGestureProfileManager.CurrentProfile[BindingInfoTemplate.CreateFromIBindingInfo(this)] == null)) {
		...
		public InputGestureCollection ActiveGestures { 
			get {
				if(UserGestureProfileManager.CurrentProfile == null 
				   || UserGestureProfileManager.CurrentProfile[BindingInfoTemplate.CreateFromIBindingInfo(this)] == null) {
					return DefaultGestures.InputGesturesCollection;
				} 
				
				return UserGestureProfileManager.CurrentProfile[BindingInfoTemplate.CreateFromIBindingInfo(this)];
			}
		}
